...
list(LENGTH SUPPORTED_AMD_ARCHS AMD_ARCH_COUNT)
if(AMD_ARCH_COUNT GREATER 0)
  math(EXPR LOOP_MAX "${AMD_ARCH_COUNT} - 1")
  foreach(LIST_INDEX RANGE ${LOOP_MAX})
    list(GET SUPPORTED_AMD_ARCHS ${LIST_INDEX} ARCH)
...
list(LENGTH SUPPORTED_AMD_ARCHS AMD_ARCH_COUNT)
if(AMD_ARCH_COUNT GREATER 0)
  math(EXPR LOOP_INDEX "${AMD_ARCH_COUNT} - 1")
  foreach(LIST_INDEX RANGE ${LOOP_INDEX})
    list(GET SUPPORTED_AMD_ARCHS ${LIST_INDEX} ARCH)
    list(GET CORRESPONDING_AMD_FLAGS ${LIST_INDEX} FLAG)
